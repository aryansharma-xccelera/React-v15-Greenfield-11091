...
const navItems = [
  { label: 'Dashboard', to: '/dashboard', icon: Icon },
  { label: 'Transactions', to: '/transactions', icon: Icon },
  { label: 'Categories', to: '/categories', icon: Icon },
  { label: 'Monthly summary', to: '/monthly-summary', icon: Icon },
]
